...
#include "action_modify_limit.h"

void ActionModifyLimit::PreAction(const std::string& query,ActionCodes *code)
{
#ifdef DEBUG
...
void ActionModifyLimit::PostAction(ActionCodes *code)
{
#ifdef DEBUG
